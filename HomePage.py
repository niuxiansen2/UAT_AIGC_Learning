...
if st.session_state["menu"] == "主页":
    ...
    with st.container(height=900):
        ...
        ### 本周（0525-0531）行业发展近况（重点关注）： 

#### （1）美国众议员新法案将限制大模型出口和中国人在美从事AI相关工作

-  --> 众议院新法案将限制大模型出口和中国人在美从事AI相关工作，43比3通过第一轮 

#### （2）中国移动年内将投产多个超万卡智算中心，开放三大人工智能基地 

- --> 近日，在中国移动人工智能生态大会上，中国移动发布了由万卡级智算集群、千亿多模态大模型、汇聚百大要素的生态平台共同构成的“九天”人工智能基座。 

#### （3）大模型及产品发布

-  --> 百度发布AI原生应用“橙篇”，支持长文理解和内容创作（05月30日） 
- --> 腾讯正式发布AI助手APP“腾讯元宝”（05月30日） 
- --> 小度推出全球首款基于文心大模型的学习机Z30，售价6699元（05月28日）
-  --> 中国电信 AI 研究院发布“星辰”超多方言语音识别大模型，支持 30 种方言混说（05月25日）
